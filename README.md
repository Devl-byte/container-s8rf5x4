...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-s8rf5x4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-s8rf5x4.containers.anotherwebservice.com/
...
```
git clone git@github.com:Devl-byte/container-s8rf5x4.git
cd container-s8rf5x4
```
...
```
docker attach container-s8rf5x4
```
